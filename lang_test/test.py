...
questions = [
    (
        "What requirements does Etendo Classic have to be installed?",
        """To install Etendo Classic, various requirements must be met on both the client and server sides. Here I detail them concisely but completely:
    ...
    (
        "How do I install Etendo Classic?",
        """ To install Etendo Classic, you can follow one of two methods: JAR format installation or source format installation. Both methods are described concisely but completely below:
    ...
    (
        "What types of user messages are there in the Etendo Classic interface?",
        """In the Etendo Classic interface, there are four types of user messages designed to inform or warn the user about different situations that require attention:
...
Each type of message has a specific purpose and helps users navigate and interact with the application more effectively, providing immediate feedback on the actions taken or problems encountered.""",
    ...
    (
        "How should I configure access to dynamic applications according to the role?",
        """To configure access to dynamic applications by role in Etendo, follow these steps:
    ...
    (
        "Can I install Etendo Classic on an AWS server?",
        """The following information has been extracted from the article https://docs.etendo.software/latest/getting-started/requirements
