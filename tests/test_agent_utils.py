...
class TestGetStructuredOutput:
    ...
    def test_get_structured_output_with_none_schema(self):
        """Test get_structured_output when schema is None."""
        agent_config = AssistantSchema(name="test_agent", output_schema=None)
    ...
    def test_get_structured_output_with_valid_json_schema(self):
        ...
        agent_config = AssistantSchema(name="test_agent", output_schema=json_schema_str)
    ...
    def test_get_structured_output_with_empty_string(self):
        """Empty string is treated as no schema — returns None without error."""
        agent_config = AssistantSchema(name="test_agent", output_schema="")
    ...
    def test_get_structured_output_with_question_schema(self):
        ...
        question_config = QuestionSchema(
            question="Test question", output_schema=json_schema_str
        )
