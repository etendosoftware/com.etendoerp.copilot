...
from copilot.core.routes import (
    _serve_agraph,
    _serve_question_async,
    core_router,
)
from copilot.core.schemas import GraphQuestionSchema, QuestionSchema
from fastapi import FastAPI
from fastapi.testclient import TestClient
from httpx import AsyncClient


# Simulation of QuestionSchema for testing purposes
@pytest.fixture
def question():
...
# Setup de FastAPI for testing
app2 = FastAPI()
app2.include_router(core_router)
...
async def test_serve_question_async(question):
    with (
        patch("copilot.core.routes._initialize_agent") as mock_initialize_agent,
...
async def test_serve_async_graph(mock_gather_responses, mock_langgraph_agent, graph_question_payload):
