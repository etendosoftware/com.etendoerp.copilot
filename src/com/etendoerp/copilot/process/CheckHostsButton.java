    ...
    private void checkEtendoHost(String token, JSONObject result) throws IOException {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                etendoHostMessage = "Error verifying ETENDO_HOST.";
    ...
    private void checkCopilotHost(String token, JSONObject result) throws IOException, JSONException {
        ...
        try {
            ...
            if (responsePythonCode == HttpServletResponse.SC_OK) {
                ...
                throw new IOException("Error verifying COPILOT_HOST: " + pythonConnection.getResponseMessage());
            }
        } catch (Exception e) {
            result.put("copilot_host", "Error verifying COPILOT_HOST: " + e.getMessage());
            result.put("etendo_host_docker", "Not verified");
