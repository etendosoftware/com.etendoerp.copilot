...
public class RestServiceUtil {
     ...
     *
     * @param copilotApp            The CopilotApp instance for which the request is to be built.
     * @param conversationId        The conversation ID to be used in the request.
     * @param jsonRequestForCopilot The JSONObject to which the request parameters are to be added.
     */
     ...
     *
     * @param copilotApp            The CopilotApp instance for which the stages and their associated assistants are to be loaded.
     * @param jsonRequestForCopilot The JSONObject to which the stages and their associated assistants are to be added.
     * @param stagesAssistants      A HashMap mapping stage names to a list of assistant names for each stage.
     */
    private static void loadStagesAssistants(CopilotApp copilotApp, JSONObject jsonRequestForCopilot, String conversationId, HashMap<String, ArrayList<String>> stagesAssistants) throws JSONException {
     ...
     *
     * @param jsonRequestForCopilot The JSONObject to which the stages are to be added.
     * @param stagesAssistants      A HashMap mapping stage names to a list of assistant names for each stage.
     */
     ...
     *
     * @param copilotApp            The CopilotApp instance for which the request is to be built.
     * @param conversationId        The conversation ID to be used in the request. If it is not empty, the conversation history will be added to the request.
     * @param jsonRequestForCopilot The JSONObject to which the request parameters are to be added.
     * @throws JSONException If an error occurs while processing the JSON data.
     */
     ...
     *
     * @param copilotApp The CopilotApp instance to be checked.
     ...
     *
     * @param copilotApp The CopilotApp instance for which the team members are to be retrieved.
     ...
     *
     * @param request The HttpServletRequest from which the conversation ID is extracted.
     * @param e       The OBException containing the error message to be included in the response.
     ...
     * @throws JSONException If an error occurs during the creation of the JSON object.
     */
     ...
     *
     * @param writerToFront The {@link PrintWriter} object used to write the event data to the response stream.
     * @param json          The {@link JSONObject} containing the data to be sent to the front-end.
     * @param addData       A boolean flag indicating whether the "data: " prefix should be added to the event data.
     */
     ...
     *
     * @param response The HttpServletResponse object to be configured for SSE.
     */
     ...
     *
     * @param writerToFront The PrintWriter to write the event data to.
     * @param x             The message to be sent to the client.
     * @param addData       A flag indicating whether to prefix the message with "data: " to conform to the SSE protocol.
     */
